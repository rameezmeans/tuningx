                ...
                <ul class="timeline-list">
                    ...
                    <li class="timeline-event">
                        ...
                        <div class="timeline-content-subevent">
                            ...
                            <p class="push-bit">{{$engineersMessage->egnineers_internal_notes}}</p>
                            <p class="push-bit"> </p>
                            <p></p>
                        ...
                        <div class="timeline-content">
                            ...
                            <span>
                                ...
                                <span>
                                    ...
                                    <ul class="actions-list">
                                        <li>
                                            <button class="btn btn-download" data-make="{{$file->brand}}" data-engine="{{$file->engine}}" data-ecu="{{$file->ecu}}" data-model="{{$file->model}}" data-generation="{{$file->version}}" data-options="{{$file->options}}" data-path="{{route('download', $row->request_file)}}">
            ...
            <div class="timeline-content">
                ...
                <span>
                    ...
                    <span>
                        ...
                        <ul class="actions-list">
                            <li>
                                <button data-make="{{$row->brand}}" data-engine="{{$row->engine}}" data-ecu="{{$row->ecu}}" data-model="{{$row->model}}" data-generation="{{$row->version}}" data-options="{{$row->options}}" data-path="{{route('download', $internal->request_file)}}" class="btn btn-download"><i class="fa fa-download"></i></button>
                            </li>
                            {{-- <li>
        ...
        <div class="push-bit">
            ...
            <div id="London1{{$internal->id}}" class="tabcontent{{$internal->id}}" style=" margin: 30px 0px;">
                <ul class="feedback">
                    ...
                    <li class="good @if( isset($internal->file_feedback->type) && $internal->file_feedback->type == 'good' ) active @endif" data-type="good" data-file_id="{{$file->id}}" data-request_file_id="{{$internal->id}}">
                        <div>
                            <svg class="eye left">
                                <use xlink:href="#eye">
                            </svg>
