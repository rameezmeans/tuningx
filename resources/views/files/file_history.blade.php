                ...
                <table class="olsx-history file-history highlight">
                    ...
                    <tbody>
                        ...
                        <tr class="redirect-click" href="#" data-redirect="{{route('file', $file->id)}}">
                            ...
                            <td class="clickable-row">
                                <span class="label @if($file->status == 'submitted' || $file->status == 'accepted') label-green @else label-red @endif">{{$file->status}}<i class="fa @if($file->status == 'submitted' || $file->status == 'accepted') fa-check @else fa-close @endif "></i></span></a>
                            </td>
