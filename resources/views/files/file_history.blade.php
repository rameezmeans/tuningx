                ...
                <table class="olsx-history file-history highlight">
                    ...
                    <tbody>
                        ...
                        <tr class="redirect-click @if($file->checked_by == 'engineer') checked @endif" href="#" data-redirect="{{route('file', $file->id)}}">
                            ...
                            <td class="clickable-row">
                                <span class="label @if($file->status == 'rejected') label-red @elseif($file->status == 'completed') label-green @elseif($file->status == 'submitted') label-grey @else label-orange @endif">{{$file->status}}<i class="fa @if( $file->status == 'accepted') fa-check @elseif($file->status == 'rejected') fa-close @endif "></i></span></a>
                            </td>
